(function($) {
    ...
    $(document).ready(function() {    
        ...
        if (scroll >= 80) {
            ...
            $(".navbar-brand img").addClass("zoomOut");
            $(".navbar-fixed-top").addClass("color-in");
            $(".navbar-brand img").removeClass("zoomIn");
        }
        else{
            $(".navbar-brand img").removeClass("zoomOut");
            $(".navbar-brand img").addClass("zoomIn");
			$(".navbar-fixed-top").removeClass("color-in");
        }
        ...
        $(window).height(function(){
            ...
            $(".single_slider").height(winHeight);
        });
        $(window).resize(function(){
            var winHeight1 = $(window).height();
            //alert(winHeight);
            
            $(".single_slider").height(winHeight1);
        });
